...
export const websiteData: WebsiteCategory[] = [
  ...
  {  
    ...
    websites: [
      {
        name: 'Gemini',
        desc: 'Google Gemini,need magic',
        logo: '/img/website/Gemini.png',
        href: 'https://gemini.google.com/app',
        tags: [''],
      },
      {
        name: 'chatgpt',
        desc: 'chatgpt,need magic',
      ...
      {
        name: 'grok',
        desc: 'grok,need magic',
        logo: '/img/website/grok.png',
        href: 'https://grok.com/',
        tags: [''],
      },
      {
        name: '智谱',
        desc: '国产大模型',
        logo: '/img/website/zhipuai.png',
        href: 'https://www.zhipuai.cn/zh',
        tags: [''],
      },
      {
        name: 'DeepSeek',
        desc: '国产大模型',
        logo: '/img/website/deepseek.png',
...

      {
        ...
        logo: '/img/website/NotebookLM.png',
        href: 'https://notebooklmai.cn/',
        tags: [''],
      },
      {
        name: 'Google Skills',
      ...
      },      
      {
        ...
        logo: '/img/website/lmarena.png',
        href: 'https://lmarena-ai.com/',
        tags: [''],
      },      
      {
        name: 'flowith',
        desc: 'flowith',
        logo: '/img/website/flowith.png',
      ...
      },      
      {
        name: 'felo',
        desc: 'felo',
        logo: '/img/website/felo.png',
        href: 'https://felo.ai/zh-Hans/search',
        tags: [''],
      },
      {
        name: 'youmind',
        desc: 'youmind',
        logo: '/img/website/youmind.png',
      ...
      {
        name: '瑞芯微',
        desc: 'RV1126/RV1109/RV1108/RV1106',
        logo: '/img/website/rockchip.png',
        href: 'https://www.rock-chips.com/',
        tags: [''],
      },   
      {
        name: '全志',
        desc: 'V831/V853/V851s',
        logo: '/img/website/allwinner.png',
...

      {
        name: '齐感科技',
        desc: 'QG21XX/QG31XX',
        logo: '/img/website/senslab.png',
        href: 'https://www.senslab.com/',
        tags: [''],
      },         
      {
        name: 'MilkV',
      ...
      },   
      {
        name: '爱芯元智',
        desc: 'AX620x/...',
        logo: '/img/website/axera.png',
        href: 'https://www.axera-tech.com/',
        tags: [''],
      },      
      {
        name: '清微智能',
